...
function SingleArticle({ article }) {
  ...
  const likeStyle = classNames(styles.blackLike, token && styles.activeLike, article.liked && styles.redLike)
      ...
      <div className={cardStyle}>
        <section className={styles.content}>
          <div className={styles.titleWrapper}>
            ...
            <button onClick={() => onLike()} className={likeStyle}>
              {article.likes}
            </button>
          </div>
        ...
        <section className={styles.info}>
          <div className={styles.authInfo}>
            ...
            <img
              ...
              onError={() => {
                setLoading(false)
                setAvatar('https://cdn-icons-png.flaticon.com/512/147/147142.png')
              }}
            />
          </div>
